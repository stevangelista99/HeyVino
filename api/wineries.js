  ...
  <div class="footer-grid">
    ...
    <div>
      ...
      <ul class="footer-links">
        ...
        <li><a href="/region/france">France</a></li>
        <li><a href="/region/italy">Italy</a></li>
        <li><a href="/region/australia-new-zealand">Australia &amp; New Zealand</a></li>
        <li><a href="/region/spain-portugal">Spain &amp; Portugal</a></li>
        ...
        <li><a href="/region/central-coast">Central Coast</a></li>
        <li><a href="/region/livermore-valley">Livermore Valley</a></li>
        <li><a href="/region/lake-county">Lake County</a></li>
      </ul>
    </div>
    <div>
...
<div id="advertiseModal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:1000;align-items:center;justify-content:center;">
  <div style="background:var(--cream);border-radius:8px;padding:2.5rem;max-width:420px;width:90%;text-align:center;position:relative;">
    ...
    <a href="mailto:Stephen@heyvinowine.com?subject=Advertise%20with%20HeyVino" style="display:block;background:var(--wine);color:white;padding:11px;border-radius:4px;font-size:0.85rem;font-weight:600;text-decoration:none;">Open in Email App \u2192</a>
  </div>
</div>
