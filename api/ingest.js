...
function extractPromoCode(subject, body, from) {
  ...
  const EXCLUDE = new Set(['HTTP', 'HTML', 'VIEW', 'SHOP', 'WINE', 'YOUR', 'FREE', 'THIS', 'THAT', 'WITH', 'FROM', 'HAVE', 'MORE', 'WILL', 'ALSO', 'BEEN', 'WERE', 'THEY', 'WHEN', 'WHAT', 'HERE', 'DEAR', 'JUST', 'OVER', 'ONLY', 'PLUS', 'SAVE', 'SALE', 'LAST', 'BEST', 'WINE', 'WINES', 'WINERY', 'CLICK', 'SHOP', 'ENJOY', 'MISS', 'DAYS', 'TAKE', 'MAKE', 'NEED', 'KNOW', 'COME', 'LOOK', 'GOOD', 'BACK', 'NEXT', 'CASE', 'EACH', 'BOTH', 'MANY', 'MOST', 'SOME', 'SUCH', 'THAN', 'THEN', 'THEM', 'WELL', 'BEEN', 'MUCH', 'EVEN', 'ALSO', 'AWAY', 'INTO', 'DOES', 'MADE', 'SAID', 'USED', 'HOURS', 'PRICES', 'RESET', 'FINAL', 'EXTRA', 'SAVINGS', 'TODAY', 'PRICE', 'DEAL', 'DEALS', 'OFFER', 'OFFERS', 'ONLINE', 'ORDER', 'ORDERS', 'CART', 'CHECKOUT', 'ACCOUNT', 'LOGIN', 'EMAIL', 'UNSUBSCRIBE', 'PRIVACY', 'TERMS', 'CONTACT', 'ABOUT', 'STORE', 'BOTTLE', 'BOTTLES', 'SHIPPING', 'DELIVERY', 'GROUND', 'STANDARD', 'MEMBER', 'MEMBERS', 'JOIN', 'SIGN', 'LEARN', 'BONUS', 'GIFTS', 'GIFT', 'SETS', 'SET']);
